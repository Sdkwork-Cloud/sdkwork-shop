# sdkwork-shop Source Configuration
...
| `appId` | `sdkwork-shop` |
| `runtimeCode` | `shop` |
| Config root | `/etc/sdkwork/shop/` |
| Runtime TOML | `/etc/sdkwork/shop/config.toml` |
| Secrets | `/etc/sdkwork/shop/secrets/` |
| Override | `SDKWORK_SHOP_CONFIG_FILE` |
